...
import com.mineup.orchestrator.adapter.in.dto.auth.CognitoTokenResponseDto;
import com.mineup.orchestrator.adapter.in.dto.auth.TokenDto;
import com.mineup.orchestrator.adapter.in.dto.auth.UrlDto;
...
public class AuthController {
    ...
    public TokenDto callback(@RequestParam("code") String code) throws URISyntaxException {
        ...
        return new TokenDto(token.id_token());
    }
}
